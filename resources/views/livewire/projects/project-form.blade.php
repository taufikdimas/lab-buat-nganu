<div class="mx-auto max-w-2xl">
    ...
    <form wire:submit="save" class="rounded-2xl border border-zinc-200 bg-white p-7 dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <div class="mt-8 flex justify-end gap-3"><flux:button :href="route('projects.index')" wire:navigate.hover>Cancel</flux:button><flux:button type="submit" variant="primary" wire:loading.attr="disabled" wire:target="save">Create project</flux:button></div>
    </form>
</div>
